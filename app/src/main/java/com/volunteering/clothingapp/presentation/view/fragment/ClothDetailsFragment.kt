...
import com.volunteering.clothingapp.databinding.LayoutClothesDetailsBinding
...
class ClothDetailsFragment : Fragment() {
    ...
    private var _binding: LayoutClothesDetailsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = LayoutClothesDetailsBinding.inflate(inflater, container, false)
